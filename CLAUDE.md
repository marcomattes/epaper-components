...
This is **EPaper**, a vanilla web component library (64 source files, 89 registered Custom Elements)
...
```
src/
  components/         64 components, one file each, ending with `define('e-tag', Class)`
