...
// interactive pages. A visitor with JavaScript disabled still gets all six
// pages, all their text and working navigation.
...
function boot(): void {
  ...
  // Only two of the six pages have behaviour, and both need the full element
  // registry. Load it after first paint so the critical path stays short —
  // and skip it entirely on the four static pages.
