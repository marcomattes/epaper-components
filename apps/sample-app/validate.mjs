...

{
  ...
  assert(
    'Custom Elements Manifest declares 96 unique custom elements',
    tags.length === 96 && unique.size === 96,
...
await withPage(async (page, consoleErrors) => {
  ...
  assert('Barrel import registers all 96 elements', tagCount === 96, `${tagCount}/96 defined`);
