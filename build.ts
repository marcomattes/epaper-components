...
const ENTRIES: ReadonlyArray<Entry> = [
  { src: "epaper-components.tokens.scss", out: "epaper-components.tokens.css" },
  { src: "epaper-components.base.scss", out: "epaper-components.base.css" },
  { src: "epaper-components.components.scss", out: "epaper-components.components.css" },
];

const BUNDLE_ENTRY: Entry = {
  src: "epaper-components.scss",
  out: "epaper-components.css",
};

const POLYFILLS: ReadonlyArray<Entry> = [
  { src: "dialog.ts", out: "epaper-components.dialog.polyfill.js" },
];
...
const minPath = path.join(DIST, "epaper-components.min.css");
let minCss = minified.styles;
if (minified.sourceMap) {
  fs.writeFileSync(`${minPath}.map`, minified.sourceMap.toString());
  minCss += "\n/*# sourceMappingURL=epaper-components.min.css.map */";
}
...
console.log(`dist/epaper-components.min.css  ${minKB} KB`);
