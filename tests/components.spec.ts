...
test.describe("Buttons", () => {
  ...
  test("primary button is visible and styled", async ({ page }) => {
    const btn = page.locator(".eink-btn--primary").first();
  ...
  test("disabled buttons have cursor not-allowed", async ({ page }) => {
    const btn = page.locator(".eink-btn:disabled").first();
    await expect(btn).toBeVisible();
...
test.describe("Text input", () => {
  ...
  test("error message is visible for invalid input", async ({ page }) => {
    const error = page.locator("#input-invalid + .eink-error-message");
...
test.describe("Dialog", () => {
  ...
  test("dialog has title and actions", async ({ page }) => {
    ...
    await expect(dialog.locator(".eink-dialog__title")).toBeVisible();
    await expect(dialog.locator(".eink-dialog__actions")).toBeVisible();
  });
});
...
test.describe("Table", () => {
  ...
  test("tables render inside scroll wrappers", async ({ page }) => {
    const wraps = page.locator(".eink-table-wrap");
  ...
  test("striped table has alternating backgrounds", async ({ page }) => {
    const rows = page.locator(".eink-table--striped tbody tr");
