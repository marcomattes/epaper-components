// Generates per-component READMEs at `src/components/<name>.md` from the
// Custom Elements Manifest produced by `cem analyze`.
//
...
//
// Outputs:
//   • src/components/<basename>.md  (one per custom element)
...
for (const mod of cem.modules ?? []) {
  ...
  const outPath = resolve(componentsDir, `${baseNoExt}.md`);
