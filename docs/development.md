...
- `demo/eink-ui.tokens.css`, `demo/eink-ui.base.css`, `demo/eink-ui.components.css` (individual files)
- `dist/eink-ui.css` (concatenated bundle, ~26 KB)
- `dist/eink-ui.min.css` (minified, ~20 KB)
- `dist/eink-ui.dialog.polyfill.js` (optional JS polyfill for `<dialog>`)
...
10 HTML pages in `demo/`, all referencing `../dist/eink-ui.css`:
...
4 HTML pages in `demo-wc/`, referencing `../dist/eink-ui.css` + `../dist/wc/index.js`:
...
2. Add `@use "components/newcomponent"` to `eink-ui.components.scss`
